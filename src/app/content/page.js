    ...
    <main style={{overflowX: 'hidden'}}>
      <section style={{
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
            <h1 style={{fontFamily: 'var(--font-montserrat)', color: '#111', fontSize: 'clamp(2.5rem, 6vw, 4rem)', fontWeight: 'bold', marginBottom: '1rem'}}>Content Creatie</h1>
            <p style={{color: '#666', fontSize: '1.1rem'}}>Home / Content Creatie</p>
        </div>
